...
const normalizeProduct = (product = {}, index = 0) => {
  ...
  return {
    ...
    capacityOrSize: product.capacityOrSize || product.capacity_or_size || product.size || 'Liên hệ tư vấn',
    capacity_or_size: product.capacity_or_size || product.capacityOrSize || product.size || 'Liên hệ tư vấn',
